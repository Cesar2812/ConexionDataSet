...
namespace CrudPersonas.dsCrudTableAdapters {
    ...
    public partial class PersonaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CrudPersonas.Properties.Settings.Default.PersonaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "UPDATE Persona set nombre=@nombre,edad=@edad where id=@id";
            ...
            this._commandCollection[4].CommandText = "DELETE from Persona where id=@id";
        ...
        public virtual int Editar(string nombre, int edad, int id) {
